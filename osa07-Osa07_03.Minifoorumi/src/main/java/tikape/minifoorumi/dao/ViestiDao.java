...
public class ViestiDao implements Dao<Viesti, Integer> {
    ...
    public List<Viesti> findAllInThread(Integer threadId) throws SQLException {
        Connection conn = database.getConnection();

        PreparedStatement stmt = conn.prepareStatement("SELECT * FROM Viesti WHERE Viesti.viestiketju_id=?");
